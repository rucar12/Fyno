...
const GoldenCircle: ForwardRefRenderFunction<HTMLDivElement, Props> = (_, ref) => {
    return (
        <Space size={8} direction={"vertical"} className={'golden-circle'}>
            <Space size={4} direction={"vertical"} ref={ref}>
...
export default forwardRef(GoldenCircle);